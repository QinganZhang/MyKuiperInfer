...
void DeconvolutionLayer::ComputeOutput(f_tensor_sptr input, f_tensor_sptr output_tensor, uint32_t kernel_h,
...
arma::fmat DeconvolutionLayer::DeconvGEMM(const f_tensor_sptr& input, uint32_t input_h, uint32_t input_w,
  ...
  f_tensor_sptr group_kernel = this->weights_.at(kernel_index);
...
void DeconvolutionLayer::DeconvCol2ImBias(const arma::fmat& gemm_result, f_tensor_sptr output_tensor,
