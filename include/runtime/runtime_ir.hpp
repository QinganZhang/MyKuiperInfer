...
public:
     ...
     */
    void set_inputs(const std::string& input_name, const std::vector<f_tensor_sptr>& inputs);
     ...
     */
    std::vector<f_tensor_sptr> get_outputs(const std::string& output_name) const;
